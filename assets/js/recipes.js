export let recipes = [{
    ...
    {
        foodName: 'Spiced tripe, liver and beef – Dullet',
        prepTime: '10 Min(s)',
        recipe: {
            ingredients: [
                '1 lb lamb tripe',
            ...
            instruction: `
                Wash the liver and tripe.
                In a pan on a medium heat, cook onions along with the butter.
                Add all the spices and mix well.
                Turn of the heat.
                Add all the meats, mix well
        `
        }
    },
    {
